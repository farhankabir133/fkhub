import{c as u,n as w,b as O,r as d,i as N,x as n,o as Q,U as be,a as ye}from"./index-C-v3Rfr0.js";import{w as xe,p as Ce,s as ke,q as Se,M as v,t as de,R as l,i as _,r as B,a as D,x as f,u as X,e as we,o as ue,j as m,f as F,k as We,v as k,c as ne,O as I,C as Z,y as se,l as A,A as V,T as $e,z as Re,b as Ae,h as Te}from"./core-eyNGPr2l.js";import"./index-CNRLwUL6.js";import"./events-CaNCSHF7.js";import"./index.es-m_Ot3pob.js";import"./node-CYZTOB1O.js";const p=Ce({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Oe={state:p,subscribe(s){return Se(p,()=>s(p))},subscribeKey(s,e){return ke(p,s,e)},showTooltip({message:s,triggerRect:e,variant:t}){p.open=!0,p.message=s,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},T=xe(Oe),pe={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){v.shake();return}if(await de.isSIWXCloseDisabled()){v.shake();return}v.close()}},Ne=_`
  :host {
    display: block;
