import {
  withRetry,
  withTimeout
} from "./chunk-MYO2IFHS.js";
import "./chunk-OWRSCR5E.js";
import {
  ...
  hexToNumber,
  numberToHex
} from "./chunk-ZKA6NJUS.js";
import "./chunk-JTBZ7SRD.js";
import "./chunk-PKTFO4U2.js";
import "./chunk-TELDGP5J.js";
import {
  ConstantsUtil,
  getTransport
} from "./chunk-MDWIUAIR.js";
import {
  W3mFrameProvider
} from "./chunk-NTCIOVIO.js";
import "./chunk-GOLCDXIT.js";
import "./chunk-O3YV4SH3.js";
import "./chunk-VPWGOEG2.js";
import "./chunk-EW2T7LJ3.js";
import "./chunk-V2XNK63E.js";
...
import {
  ...
  extractRpcUrls,
  injected
} from "./chunk-TNHPMRL6.js";
import "./chunk-5PODBOTR.js";
import "./chunk-FVSBVWAL.js";
import "./chunk-QRHJGIPK.js";
import "./chunk-WKPAJXGZ.js";
import "./chunk-QG7UTK7O.js";
import "./chunk-5FBSON6U.js";
import {
  SwitchChainError,
  getAddress
} from "./chunk-JR7PN33A.js";
import "./chunk-7JET5NM2.js";
import "./chunk-CDJCEDMD.js";
import "./chunk-EHM7MUJ3.js";
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-TTW6PLH3.js");
    ...
    async switchChain({ addEthereumChainParameter, chainId }) {
      ...
      if (!chain)
        throw new SwitchChainError2(new ChainNotConfiguredError());
      const provider = await this.getProvider();
      try {
    ...
    onAccountsChanged(accounts) {
      if (accounts.length === 0)
        ...
        config.emitter.emit("change", {
          accounts: accounts.map((x) => getAddress2(x))
        });
    },
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-VLIS2FCM.js");
...
function metaMask(parameters = {}) {
  ...
  return createConnector((config) => ({
      ...
      try {
        ...
        if (!(accounts == null ? void 0 : accounts.length)) {
          if (parameters.connectAndSign || parameters.connectWith) {
            ...
            accounts = requestedAccounts.map((x) => getAddress2(x));
          }
        }
        let currentChainId = await this.getChainId();
        if (chainId && currentChainId !== chainId) {
    ...
    async getAccounts() {
      ...
      return accounts.map((x) => getAddress2(x));
    },
    async getChainId() {
      const provider2 = await this.getProvider();
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-DBPWWFOM.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
        ...
        ((_b = (_a = error == null ? void 0 : error.data) == null ? void 0 : _a.originalError) == null ? void 0 : _b.code) === 4902) {
          try {
            ...
            if (error2.code === UserRejectedRequestError.code)
              throw new UserRejectedRequestError(error2);
            throw new SwitchChainError2(error2);
          }
        }
        throw new SwitchChainError2(error);
      }
...
function safe(parameters = {}) {
  ...
  return createConnector((config) => ({
    ...
    async getAccounts() {
      ...
      if (!provider)
        throw new ProviderNotFoundError();
      return (await provider.request({ method: "eth_accounts" })).map(getAddress2);
    },
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-MK27TVYF.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-ZCE3IHU6.js");
  ...
  return createConnector((config) => ({
    ...
    async connect({ chainId, ...rest } = {}) {
      ...
      try {
        ...
        const accounts = (await provider.enable()).map((x) => getAddress2(x));
    ...
    async getAccounts() {
      const provider = await this.getProvider();
      return provider.accounts.map((x) => getAddress2(x));
    },
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-YOGAKJWF.js");
